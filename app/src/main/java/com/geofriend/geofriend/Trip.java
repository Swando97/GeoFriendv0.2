...
public class Trip {
    private int maximun=20;                             //maximun landmark can include
    private int Count=0;
    private String Name;
    ...
    public Trip(int count, String name, String creator, String intro, com.geofriend.geofriend.LandMark[] landMark, String[] landMarkComment, int code, int rating) {
        Count = count;
        Name = name;
        Creator = creator;
        Intro = intro;
    ...
    public void updateTrip(int count, String name, String creator, String intro, com.geofriend.geofriend.LandMark[] landMark, String[] landMarkComment, int code, int rating){
        Trip old=new Trip(Count,Name,Creator,Intro,LandMark,LandMarkComment,Code,Rating);
        setCount(count);
        setName(name);
        setIntro(intro);
